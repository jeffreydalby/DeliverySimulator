...
public class ProductNames {
    ...
    public enum names {
        ...
        frozenDinner3("Frozen Dinner Special #2",true,false,ProductClassification.type.frozenDinner),
        frozenDinner4("Frozen Dinner Special #2",true,false,ProductClassification.type.frozenDinner),
        ...
        beijingBeef("Beijin Beef",false,true,ProductClassification.type.chinese),
        friedRice("Fried Rice",false,true,ProductClassification.type.chinese),
        eggRoll("BEgg Roll",false,true,ProductClassification.type.chinese),
